...
INSERT INTO contacts_new (id, name, contact_type, phone, email, address, notes, is_active, created_at, updated_at, maps_link, class, distance_km, has_sibling_discount, is_return_only, route_id)
SELECT id, name, contact_type, phone, email, address, notes, is_active, created_at, updated_at, maps_link, class, distance_km, has_sibling_discount, is_return_only, route_id
FROM contacts;
